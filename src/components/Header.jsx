...
const Header = () => {
  ...
  useEffect(()=>{onChangefromHandler(fromValue)},[fromCurrency])
  useEffect(()=>{onChangetoHandler(toValue)},[toCurrency])
  return (
    <div className="App">
      <CurrencyBox value={fromValue} currency={fromCurrency} currencyHandler={setFromCur} valueHandler={onChangefromHandler}/>
      <CurrencyBox value={toValue} currency={toCurrency} currencyHandler={setToCur} valueHandler={onChangetoHandler}/>
    </div>
  );
}
